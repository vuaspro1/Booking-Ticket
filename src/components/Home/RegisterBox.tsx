...
const HomeBox: FC<HomeBoxProps> = (props: HomeBoxProps) => {
	...
	const getRegister = async () => {
		...
		if (numeral(quantity1).value()) {
			listOrderItems.push({ productId: 1, quantity: numeral(quantity1).value() })
		}
		if (numeral(quantity2).value()) {
			listOrderItems.push({ productId: 2, quantity: numeral(quantity2).value() })
		}
		if (numeral(quantity3).value()) {
			listOrderItems.push({ productId: 3, quantity: numeral(quantity3).value() })
		}
		if (numeral(quantity4).value()) {
			listOrderItems.push({ productId: 4, quantity: numeral(quantity4).value() })
		}
		if (numeral(quantity5).value()) {
			listOrderItems.push({ productId: 5, quantity: numeral(quantity5).value() })
		}
		if (numeral(quantity6).value()) {
			listOrderItems.push({ productId: 6, quantity: numeral(quantity6).value() })
		}
		if (numeral(quantity7).value()) {
			listOrderItems.push({ productId: 7, quantity: numeral(quantity7).value() })
		}
					...
					<div className="row">
						<div className="col-md-6">
							<div className="is-text">
								...
								<div className="row">
									<div className="col-4">
										<div className="is-img-l">
											<img src="/images/cong-doan/sp1n.png" />
										</div>
										<label>{'Bộ "Gia Đình Hạnh Phúc" (trắng), số lượng:'}</label>
										<InputNumber min={0} onChange={(e: number) => setQuantity1(e)} value={quantity1} />
									</div>
									<div className="col-4">
										<div className="is-img-l">
											<img src="/images/cong-doan/sp2n.png" />
										</div>
										<label>{'Bộ "Tết Đoàn Viên" (trắng), số lượng:'}</label>
										<InputNumber min={0} onChange={(e: number) => setQuantity2(e)} value={quantity2} />
									</div>
									<div className="col-4">
										<div className="is-img-l">
											<img src="/images/cong-doan/sp3n.png" />
										</div>
										<label>{'Bộ "Phú Quý Cát Tường" (trắng), số lượng:'}</label>
								...
								<div className="row">
									<div className="col-4">
										...
										<label>{'Bộ "Gia Đình Hạnh Phúc" (hoa), số lượng:'}</label>
									...
									<div className="col-4">
										...
										<label>{'Bộ "Tết Đoàn Viên" (hoa), số lượng:'}</label>
									...
									<div className="col-4">
										...
										<label>{'Bộ "Phú Quý Cát Tường" (kẻ vàng), số lượng:'}</label>
								...
								<div className="row">
									...
									<div className="col-4">
										...
										<label>{'Bộ "Tết Đoàn Viên" (kẻ vàng), số lượng:'}</label>
